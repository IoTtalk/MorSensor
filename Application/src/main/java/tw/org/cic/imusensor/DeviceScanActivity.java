...
//    public final static String MorSensorAddress = "xx:xx:xx:xx:xx:xx";
//    public final static String MorSensorAddress2 = "xx:xx:xx:xx:xx:xx";
//    public final static String MorSensorAddress3 = "xx:xx:xx:xx:xx:xx";
...
//        final Intent intent = new Intent(this, MeterViewActivity.class);
...
//        if (device.getAddress().equals(MorSensorAddress) || device.getAddress().equals(MorSensorAddress2) || device.getAddress().equals(MorSensorAddress3)) {
            ...
            startActivity(intent);
            finish();
//        }else{ Toast.makeText(this, "This device is not IMU sensor.", Toast.LENGTH_SHORT).show(); }
    }
